...
public:
	...
	static void DrawRect(const Vec2f& pos, const Vec2f& size, int z, Ref<Texture> texture, const Color4f& color = Colors::WHITE);
	static void DrawRect(const Vec2f& pos, const Vec2f& size, int z = 0.0f, const Color4f& color = Colors::WHITE);
	static void DrawRect(const Vec2f& pos, const Vec2f& size, int z, const Rect2D& region, Ref<Texture> texture, const Color4f& color = Colors::WHITE);
